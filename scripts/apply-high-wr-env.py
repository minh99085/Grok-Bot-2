#!/usr/bin/env python3
"""Merge HIGH WIN RATE pulse env vars into hermes-trading-engine/.env (loop-arch aligned)."""
...
UPDATES = {
    ...
    # Loop arch: TV is observe-only context — not directional trade authority.
...
out.append("# HIGH WIN RATE profile (2026-06-25, loop-arch: TV observe-only)")
ENV_PATH.write_text("\n".join(out) + "\n", encoding="utf-8")
