...
UPDATES = {
    ...
    # Grok compute budget + tiered decider (light/full/deep).
    "GROK_BUDGET_DAILY_USD": "50",
    "GROK_EST_USD_PER_CALL": "0.02",
    "GROK_SIGNAL_PREDICTOR_ENABLED": "1",
    "GROK_SIGNAL_ANALYST_ENABLED": "1",
    "GROK_PREDICTOR_MAX_CALLS_PER_HOUR": "90",
    "GROK_ANALYST_MAX_CALLS_PER_HOUR": "8",
    "PULSE_GROK_DECIDER_MAX_CALLS_PER_HOUR": "200",
