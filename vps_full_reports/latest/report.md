...
_Generated: 2026-06-16T05:08:32.130518+00:00 · PAPER ONLY · inspection/reporting only_
...
| Field | Value |
|---|---|
| chainlink_anchor_price | 65863.46 |
| fast_btc_price | None |
| feed_disagreement_bps | None |
| market_stale_time_s | 1857.225 |
...
| groups_scanned_positive | OK | constraint_groups_scanned=589.0 |
...
- Paper training running: yes · runtime: 102.1 min
...
- preflight_ok: yes · scanned=2000 kept=1803
...
- chainlink_valid: no
- chainlink_stale: yes
- chainlink_age_seconds: 1857.225
- chainlink_price: 65863.46
...
- grok_calls_total: 4
- grok_calls_with_news: 4
- grok_proof_calls_total: 0
- grok_scheduler_calls_total: 4
- grok_total_calls_reconciled: True
- grok_scheduled_calls: 4
- grok_scheduler_eligible_targets: 806
- grok_scheduler_targets_selected: 4
- grok_scheduler_targets_skipped: 16
- grok_scheduler_skip_reasons: {'not_due_yet': 16}
- grok_advisory_only_count: 4
- grok_evidence_records_written: 4
- grok_advisory_max_calls_per_hour: 4
- grok_advisory_calls_per_hour: 2
- grok_market_groups_analyzed: 3
- grok_bregman_near_misses_analyzed: 3
- grok_bregman_incomplete_groups_analyzed: 3
- grok_bregman_malformed_groups_analyzed: 1
- grok_news_linked_markets_analyzed: 4
- grok_learning_features_written: 4
...
- constraint_groups_scanned: 800
- candidate_arbitrages: 0
- certified_arbitrages: 0
- best_projected_profit_per_set: 0.0
- max_bregman_distance: 0.0005
- mean_cost_per_set: 1.015027
- expected_min_profit: 0.0
- near_miss_count: 10
- stage_rejections: {'adapter_failed': 1456, 'certifier_no_positive_profit': 800, 'realism_fees_spread_depth': 0, 'other': 0}
...
- bregman_near_misses_total: 797
- near_miss_one_fix_away_count: 114
- near_miss_depth_only_count: 113
- near_miss_not_exhaustive_count: 234
- near_miss_stale_refresh_failed_count: 0
- near_miss_by_rejection_reason: {'depth_too_thin': 120, 'invalid_simplex': 120, 'no_positive_edge': 223, 'not_exhaustive': 234, 'stale_book': 100}
- near_miss_learning_priority_counts (high/med/low): {'high': 101, 'medium': 573, 'low': 123}
- near_miss_shadow_label_candidate_count: 101
- near_miss_learning_label_counts: {'needs_multiple_fixes': 460, 'no_positive_after_cost_edge': 223, 'would_certify_if_book_fresh': 1, 'would_certify_if_depth_sufficient': 113}
  - learn: binary:event:107711 priority=high(1.0) label=would_certify_if_depth_sufficient shadow_candidate=True would_trade_if=worst-leg depth $19.1998 reaches required $25.0 (thin legs=1)
  - learn: binary:event:108639 priority=high(1.0) label=would_certify_if_depth_sufficient shadow_candidate=True would_trade_if=worst-leg depth $21.7702 reaches required $25.0 (thin legs=1)
  - learn: binary:event:211827 priority=high(1.0) label=would_certify_if_depth_sufficient shadow_candidate=True would_trade_if=worst-leg depth $13.143 reaches required $25.0 (thin legs=1)
  - learn: binary:event:591091 priority=high(1.0) label=would_certify_if_depth_sufficient shadow_candidate=True would_trade_if=worst-leg depth $11.0249 reaches required $25.0 (thin legs=1)
  - learn: binary:event:583974 priority=high(1.0) label=would_certify_if_depth_sufficient shadow_candidate=True would_trade_if=worst-leg depth $19.78 reaches required $25.0 (thin legs=1)

### 11b. Bregman Price/Outcome Parsing + Depth Census (read-only)

- non_numeric_price_count: 0
- insufficient_outcomes_count: 0
- malformed_group_count: 261468
- parsed_price_success_rate: 1.0
- bregman_depth_sufficient_groups: 145
- bregman_depth_insufficient_groups: 444
- bregman_high_liquidity_groups_scanned: 104
- bregman_all_groups_thin: False
- complete_set_count (certified): 0
- incomplete_set_count (not_exhaustive near-misses): 234
...
Top Bregman near-misses (diagnostic only — NOT executed):
  ...
  - binary:event:594586 reason=no_positive_edge score=0.9 market_ids=['2544062'] token_ids=<REDACTED> '<REDACTED>'] labels=['YES', 'NO'] one_fix_away=False tradeable=False blockers=[]
  ...
  - binary:event:46844 reason=no_positive_edge score=0.9 market_ids=['604470'] token_ids=<REDACTED> '<REDACTED>'] labels=['YES', 'NO'] one_fix_away=False tradeable=False blockers=[]

### 11c. Bregman Certifier / Candidate Health (read-only)

- bregman_groups_entered_certifier: 589
...
- bregman_real_market_zero_candidate_reason_counts: {'depth_too_thin': 91, 'invalid_simplex': 23, 'no_executable_price': 1, 'no_positive_edge': 131, 'not_exhaustive': 217, 'stale_book': 126}
- bregman_depth_sufficient_groups: 145
- bregman_depth_sufficient_but_negative_edge_count: 145
- bregman_best_depth_sufficient_group_lower_bound: -0.001
- bregman_best_depth_sufficient_group_reject_reason: no_positive_edge
- best_real_group: binary:event:36173 depth_sufficient=True min_leg_depth=$67.9062 (required $25.0) reject=no_positive_edge lower_bound=-0.001 market_ids=['573655'] labels=['YES', 'NO']
  - sample: group=binary:event:551781 reason=depth_too_thin depth_sufficient=False market_ids=['2419359'] token_ids=<REDACTED> '<REDACTED>'] labels=['YES', 'NO']
...
- malformed_group_count (reconciled): 261468
- bregman_malformed_group_reported_count (trainer certifier): 0
- bregman_malformed_group_runtime_count (ABCAS scanner): 512
- bregman_malformed_group_tail_count (diagnostics tail): 261468
- bregman_malformed_group_legacy_or_tail_only_count: 260956
- source: abcas_scanner_path_real_rejects

### 11d-stage. Trainer Certifier Per-Stage Census (read-only)

- bregman_rejection_stage_counts: {'edge': 131, 'realism': 218, 'validate_simplex': 240}
- bregman_max_divergence_gap (D(mu*||theta)): 15.76644177
- bregman_best_projected_lower_bound: 0.999
- bregman_positive_projected_but_rejected_count: 128
- bregman_positive_projected_rejected_by_stage: {'realism': 11, 'validate_simplex': 117}
- WHY certified=0: dominant stage=validate_simplex: groups are structurally INCOMPLETE (exhaustive=False / not a provable complete set) — buying a partial set is not a guaranteed hedge, so it is correctly NOT certified (completeness is never fabricated); NOTE: 128 group(s) had POSITIVE raw projected profit (best=0.999) but were still rejected (realism=11, validate_simplex=117) — the raw mispricing is real, but the set is not a certifiable complete hedge
- profit_lower_bound (min/mean/max): -20.451 / -0.059973 / 0.999
- groups by lower_bound sign (neg/zero/pos): 459 / 2 / 128
  ...
  - group: event:event:548813 exhaustive=False settlement_consistent=False profit_lower_bound=-0.74 divergence_gap=0.1369 reason=not_exhaustive
  ...
  - group: event:event:599761 exhaustive=False settlement_consistent=False profit_lower_bound=0.998 divergence_gap=0.498002 reason=not_exhaustive
  - group: binary:event:511452 exhaustive=True settlement_consistent=True profit_lower_bound=-0.01 divergence_gap=5e-05 reason=stale_book
  ...
  - near_miss: binary:event:594586 stage=edge exhaustive=True settlement_consistent=True divergence_gap=1.8e-05 projected_lb=-0.006 reason=no_positive_edge
...
- bregman_shadow_label_candidates: 101
- bregman_shadow_labels_written: 144
- bregman_shadow_label_write_rate: 1.4257
- shadow_records_written: 5963
- shadow_labels_tail_nonempty: True
- shadow_label_write_rejection_reasons: {'already_written': 3631}
- profit_discovery_queue_items: 797
- profit_discovery_queue_by_priority: {'2': 113, '3': 201, '5': 483}
- profit_learning_status: shadow_data_only
- profit_data_sufficiency: building
- bandit_router_enabled: True
- bandit_action_counts: {'bregman_depth_watchlist': 2, 'bregman_not_exhaustive_completer': 2, 'bregman_rebalancing_watchlist': 2, 'grok_news_linked_near_miss': 8, 'active_learning_shadow': 24}
- bandit_action_rewards: {'bregman_depth_watchlist': 0.0, 'bregman_not_exhaustive_completer': 0.0, 'bregman_rebalancing_watchlist': 0.0, 'grok_news_linked_near_miss': 8.0, 'active_learning_shadow': 34.0}
...
- targeted_scan_bregman_groups_seen: 797
- targeted_scan_binary_groups_seen: 549
- targeted_scan_yes_no_pairs_seen: 443
- targeted_scan_binary_group_matches: 391 raw_market_matches=1735
- targeted_scan_bregman_categories: {'complete_yes_no_tight_spread': 336, 'high_liquidity_binary': 224}
- targeted_scan_raw_market_categories: {'complete_yes_no_tight_spread': 11, 'short_resolution': 1098, 'btc_eth_chainlink': 157, 'fed_macro_reference': 43, 'high_volume_news_linked': 1}
- targeted_scan_normalized_reject_reasons: {'depth_too_thin': 120, 'not_exhaustive': 234, 'stale_book': 100, 'no_positive_edge': 223, 'invalid_simplex': 120}
...
- bregman_clob_hydration_eligible_groups: 589 selected=250 coverage_rate=0.4244
...
- paper_relaxed_after_cost_positive_seen: 1 real_clob_book_seen=9005
- paper_relaxed_readiness_pnl_excluded: True
- paper_relaxed_reject_reasons: {'bregman_leg_stale_book': 1}
- paper_relaxed_pipeline_scanned: 22177
- paper_relaxed_real_book_candidates_seen: 9005 positive=1
- paper_relaxed_candidate_source_counts: {'binary_yes_no': 9005}
- paper_relaxed_candidates_blocked_by_reason: {'negative_after_cost_edge': 7572, 'depth_insufficient_for_1usd': 936, 'stale_book': 496}
- paper_relaxed_best_real_book_candidate: {'group_id': 'binary:event:596476', 'group_type': 'binary_yes_no', 'after_cost_edge': 0.007525, 'reject_reason': '', 'depth_for_1usd': 2.45, 'n_legs': 2}
- paper_relaxed_best_reject_example: {'group_id': 'binary:event:108634', 'group_type': 'binary_yes_no', 'after_cost_edge': -0.003502, 'reject_reason': 'negative_after_cost_edge', 'depth_for_1usd': 6.4556, 'n_legs': 2}
- bregman_false_incomplete_family_count: 0 near_miss_promoted=0
- bregman_incomplete_family_examples: [{'group_id': 'event:event:548813', 'n_legs_scanned': 4, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:599761', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:595508', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:580348', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:255195', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:139507', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:351756', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:34051', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}]
- accelerated_discovery_enabled: True
- markets_scanned_per_tick: 1803 candidates_evaluated_per_tick=589 shadow_labels_per_tick=150 no_trade_labels_per_tick=589
- near_miss_records_written: 797 bregman_diagnostics_records_written=22177
- top_near_miss_edges_after_cost: [0.999, 0.999, 0.999, 0.999, 0.999, 0.999, 0.999, 0.999, 0.999, 0.998]
- top_bregman_rejection_reasons: [{'reason': 'not_exhaustive', 'count': 8303}, {'reason': 'no_positive_edge', 'count': 5011}, {'reason': 'stale_book', 'count': 4437}, {'reason': 'depth_too_thin', 'count': 3751}, {'reason': 'invalid_simplex', 'count': 659}, {'reason': 'no_executable_price', 'count': 16}, {'reason': 'bregman_leg_stale_book', 'count': 1}]
- report_buckets: {'realistic_executable_trades': 5, 'bregman_certified_bundles': 0, 'directional_exploit_trades': 5, 'shadow_exploration': 0, 'no_trade_labels': 589, 'near_miss_rejects': 797, 'paper_relaxed_exploration_trades': 0}
...
- market_quality_tier_counts: {'gold': 0, 'silver': 1, 'bronze': 812, 'watch': 767, 'reject_or_diagnostic': 223}
- market_quality_score_distribution: {'0.8+': 0, '0.6-0.8': 1, '0.4-0.6': 830, '0.2-0.4': 900, '<0.2': 72}
- targeted_scan_budget_by_category: {'complete_yes_no_tight_spread': 10, 'short_resolution': 927, 'btc_eth_chainlink': 132, 'fed_macro_reference': 41, 'high_volume_news_linked': 1, 'broad_exploration': 600}
- targeted_scan_markets_by_category: {'complete_yes_no_tight_spread': 11, 'short_resolution': 1098, 'btc_eth_chainlink': 157, 'fed_macro_reference': 43, 'high_volume_news_linked': 1, 'broad_exploration': 650}
- high_liquidity_binary_markets_scanned: 224
- complete_yes_no_tight_spread_markets_scanned: 347
- negative_risk_complete_events_scanned: 0
- short_resolution_markets_scanned: 1098
- btc_eth_chainlink_markets_scanned: 157
- fed_macro_reference_markets_scanned: 43
- high_volume_news_linked_markets_scanned: 1
- complete_event_families_scanned: 0
- thin_depth_scan_waste_count (KNOWN-thin only): 1799
- stale_book_scan_waste_count (KNOWN-stale only): 1762
- targeted_scan_missing_data_counts (NOT waste): {'missing_book_timestamp': 0, 'missing_depth': 5, 'missing_volume': 0}
- scan_deprioritized_groups: 2 cooldown_active=1831 reasons={'stale_book': 2, 'thin_depth': 2}
- not_exhaustive_high_quality_groups: 0 (sibling=0 grok=0 shadow_only=0)
- targeted_scan_noop_reasons: {'negative_risk_complete': '0/1803 markets carried negRiskComplete/outcomeCount metadata proving a complete event family (completeness is never inferred from titles)', 'complete_event_family': '0/1803 markets carried negRiskComplete/outcomeCount metadata proving a complete event family (completeness is never inferred from titles)', 'thin_depth_deprioritized': '0/1803 markets matched thin_depth_deprioritized (binaries seen=549)', 'stale_book_refresh': '0/1803 markets matched stale_book_refresh (binaries seen=549)'}
  - best: 1892283 tier=silver score=0.604796 categories=['short_resolution', 'high_volume_news_linked']
  - best: 2326667 tier=bronze score=0.564385 categories=['complete_yes_no_tight_spread', 'short_resolution']
  - best: 2410578 tier=bronze score=0.559834 categories=['short_resolution', 'btc_eth_chainlink']
...
- total_candidates_considered: 23
- realistic_trade_count: 6
...
- active_learning_tiny_trades_selected: 22
- active_learning_tiny_trades_opened: 6
- relaxed_bregman_trades_opened: 0
- btc_pulse_paper_trades_opened: 0
- exploration_pnl: -0.0189
- readiness_pnl_excludes_exploration: yes
- active_learning_tiny_trades_blocked_by_reason: {'collision_blocked': 16}

Lane-specific zero-trade blockers (empty == lane opened >=1 paper trade):
- bregman_blocker: no_certified_bregman_opportunity: dominant_reject=not_exhaustive(8303)
...
- directional_slots_after_bregman: 3
...
- profitability_buckets: {'exploration_feedback_positive': 22}
...
- Tiny evaluator called: 22
- Tiny candidates evaluated: 22
- Tiny trades selected: 22
- Tiny trades opened: 6
- Selected-but-not-evaluated (must be 0): 0
- Tiny blocked by reason: {'collision_blocked': 16}
- Random exploration enabled: no (should be false)
- Random/hash exploration opened trades: 0 (should be 0)
- Legacy random exploration blocked: 148
- Exploration counted toward readiness: no (should be false)
- Exploration consumes Bregman reserved capacity: no (should be false)
- active_learning_candidates_considered: 4560
- active_learning_candidates_selected: 4560
- exploration_trades_opened: 6
- exploration_shadow_only: 394
- exploration_rejected_by_realism: 92
- exploration_rejected_by_budget: 1
- exploration_rejected_by_collision: 0
- exploration_rejected_by_diversity: 0
- exploration_budget_used_usd: 6.0
- exploration_expected_loss_usd: 0.05
- exploration_pnl: -0.0189
- avg_active_learning_score_selected: 0.945811
- avg_execution_quality_selected: 0.216368
- top_learning_buckets: ['category_under_sampled', 'calibration_gap_bucket']
- category_coverage: {'uncategorized': 22}
...
- exploration_trades_blocked_by_correlation: 16
- bregman_bundles_blocked_as_duplicates: 0
- bregman_bundles_blocked_as_overlapping: 0
- max_cluster_exposure_usd: 1.0003
- max_event_exposure_usd: 1.0003
- top_open_clusters: [{'cluster': 'event:79987', 'count': 1, 'notional': 1.0003}, {'cluster': 'event:511452', 'count': 1, 'notional': 1.0001}, {'cluster': 'event:45915', 'count': 1, 'notional': 0.9999}, {'cluster': 'event:413862', 'count': 1, 'notional': 0.9975}]
...
- metrics: present (not copied) (49015389 bytes)
- reports: copied (13786 bytes)
- training: present (not copied) (7281270614 bytes)
- micro_live_artifacts: copied (2056476 bytes)
...
| max_drawdown | -0.0189 | 0.15 | lower | PASS | Max drawdown (fraction of equity). |
