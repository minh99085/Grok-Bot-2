...
_Generated: 2026-06-16T00:37:07.788626+00:00 · PAPER ONLY · inspection/reporting only_
...
| Field | Value |
|---|---|
| chainlink_anchor_price | 66188.87549779 |
| fast_btc_price | None |
| feed_disagreement_bps | None |
| market_stale_time_s | 3440.125 |
...
| groups_scanned_positive | OK | constraint_groups_scanned=556.0 |
...
- Paper training running: yes · runtime: 1.96 min
...
- chainlink_valid: no
- chainlink_stale: yes
- chainlink_age_seconds: 3440.125
- chainlink_price: 66188.87549779
...
- mean_cost_per_set: 1.020514
- expected_min_profit: 0.0
- near_miss_count: 10
- stage_rejections: {'adapter_failed': 1423, 'certifier_no_positive_profit': 831, 'realism_fees_spread_depth': 0, 'other': 0}
...
- bregman_near_misses_total: 556
- near_miss_one_fix_away_count: 112
- near_miss_depth_only_count: 104
- near_miss_not_exhaustive_count: 204
- near_miss_stale_refresh_failed_count: 0
- near_miss_by_rejection_reason: {'depth_too_thin': 112, 'invalid_simplex': 16, 'no_positive_edge': 120, 'not_exhaustive': 204, 'spread_too_wide': 1, 'stale_book': 103}
- near_miss_learning_priority_counts (high/med/low): {'high': 100, 'medium': 334, 'low': 122}
- near_miss_shadow_label_candidate_count: 100
- near_miss_learning_label_counts: {'needs_multiple_fixes': 324, 'no_positive_after_cost_edge': 120, 'would_certify_if_book_fresh': 8, 'would_certify_if_depth_sufficient': 104}
  - learn: binary:event:211827 priority=high(1.0) label=would_certify_if_depth_sufficient shadow_candidate=True would_trade_if=worst-leg depth $13.0994 reaches required $25.0 (thin legs=1)
  - learn: binary:event:410233 priority=high(1.0) label=would_certify_if_depth_sufficient shadow_candidate=True would_trade_if=worst-leg depth $8.415 reaches required $25.0 (thin legs=1)
  - learn: binary:event:569695 priority=high(1.0) label=would_certify_if_depth_sufficient shadow_candidate=True would_trade_if=worst-leg depth $19.0505 reaches required $25.0 (thin legs=1)
  - learn: binary:event:276527 priority=high(1.0) label=would_certify_if_depth_sufficient shadow_candidate=True would_trade_if=worst-leg depth $10.3785 reaches required $25.0 (thin legs=1)
  - learn: binary:event:162089 priority=high(1.0) label=would_certify_if_depth_sufficient shadow_candidate=True would_trade_if=worst-leg depth $11.8813 reaches required $25.0 (thin legs=1)

### 11b. Bregman Price/Outcome Parsing + Depth Census (read-only)

- non_numeric_price_count: 0
- insufficient_outcomes_count: 0
- malformed_group_count: 258068
- parsed_price_success_rate: 1.0
- bregman_depth_sufficient_groups: 129
- bregman_depth_insufficient_groups: 427
- bregman_high_liquidity_groups_scanned: 83
- bregman_all_groups_thin: False
- complete_set_count (certified): 0
- incomplete_set_count (not_exhaustive near-misses): 204
...
- bregman_groups_entered_certifier: 556
...
- bregman_real_market_zero_candidate_reason_counts: {'depth_too_thin': 112, 'invalid_simplex': 16, 'no_positive_edge': 120, 'not_exhaustive': 204, 'spread_too_wide': 1, 'stale_book': 103}
- bregman_depth_sufficient_groups: 129
- bregman_depth_sufficient_but_negative_edge_count: 129
- bregman_best_depth_sufficient_group_lower_bound: -0.001
- bregman_best_depth_sufficient_group_reject_reason: no_positive_edge
- best_real_group: binary:event:36173 depth_sufficient=True min_leg_depth=$79.3257 (required $25.0) reject=no_positive_edge lower_bound=-0.001 market_ids=['573655'] labels=['YES', 'NO']
...
- malformed_group_count (reconciled): 258068
- bregman_malformed_group_reported_count (trainer certifier): 0
- bregman_malformed_group_runtime_count (ABCAS scanner): 508
- bregman_malformed_group_tail_count (diagnostics tail): 258068
- bregman_malformed_group_legacy_or_tail_only_count: 257560
- source: abcas_scanner_path_real_rejects

### 11d-stage. Trainer Certifier Per-Stage Census (read-only)

- bregman_rejection_stage_counts: {'edge': 120, 'realism': 216, 'validate_simplex': 220}
- bregman_max_divergence_gap (D(mu*||theta)): 16.01449523
- bregman_best_projected_lower_bound: 0.999
- bregman_positive_projected_but_rejected_count: 114
- bregman_positive_projected_rejected_by_stage: {'realism': 11, 'validate_simplex': 103}
- WHY certified=0: dominant stage=validate_simplex: groups are structurally INCOMPLETE (exhaustive=False / not a provable complete set) — buying a partial set is not a guaranteed hedge, so it is correctly NOT certified (completeness is never fabricated); NOTE: 114 group(s) had POSITIVE raw projected profit (best=0.999) but were still rejected (realism=11, validate_simplex=103) — the raw mispricing is real, but the set is not a certifiable complete hedge
- profit_lower_bound (min/mean/max): -20.654 / -0.080079 / 0.999
- groups by lower_bound sign (neg/zero/pos): 441 / 1 / 114
  ...
  - group: event:event:548813 exhaustive=False settlement_consistent=False profit_lower_bound=-0.78 divergence_gap=0.1521 reason=not_exhaustive
  - group: binary:event:542904 exhaustive=True settlement_consistent=True profit_lower_bound=-0.05 divergence_gap=0.00125 reason=no_positive_edge
  ...
  - near_miss: binary:event:542904 stage=edge exhaustive=True settlement_consistent=True divergence_gap=0.00125 projected_lb=-0.05 reason=no_positive_edge
...
- bregman_shadow_label_candidates: 100
- bregman_shadow_labels_written: 100
- bregman_shadow_label_write_rate: 1.0
- shadow_records_written: 5339
- shadow_labels_tail_nonempty: True
- profit_discovery_queue_items: 556
- profit_discovery_queue_by_priority: {'2': 104, '3': 137, '5': 315}
...
- targeted_scan_bregman_groups_seen: 556
- targeted_scan_binary_groups_seen: 336
- targeted_scan_yes_no_pairs_seen: 336
- targeted_scan_binary_group_matches: 336 raw_market_matches=1697
- targeted_scan_bregman_categories: {'complete_yes_no_tight_spread': 224, 'high_liquidity_binary': 128}
- targeted_scan_raw_market_categories: {'short_resolution': 1027, 'btc_eth_chainlink': 156, 'fed_macro_reference': 43, 'high_volume_news_linked': 1}
- targeted_scan_normalized_reject_reasons: {'depth_too_thin': 112, 'not_exhaustive': 204, 'no_positive_edge': 120, 'stale_book': 103, 'spread_too_wide': 1, 'invalid_simplex': 16}
...
- bregman_hydration_failure_reasons: {'no_book_or_no_ask': 12}
- bregman_clob_hydration_eligible_groups: 556 selected=250 coverage_rate=0.4496
...
- zero_trade_blocker_if_any: real_book_candidates_but_no_positive_after_cost_edge: real_book_candidates_seen=238; positive=0; best_after_cost_edge=-0.0035; best_reject={'group_id': 'binary:event:36173', 'group_type': 'binary_yes_no', 'after_cost_edge': -0.003502, 'reject_reason': 'negative_after_cost_edge', 'depth_for_1usd': 79.3257, 'n_legs': 2}
...
- paper_relaxed_after_cost_positive_seen: 0 real_clob_book_seen=238
- paper_relaxed_readiness_pnl_excluded: True
- paper_relaxed_pipeline_scanned: 556
- paper_relaxed_real_book_candidates_seen: 238 positive=0
- paper_relaxed_candidate_source_counts: {'binary_yes_no': 238}
- paper_relaxed_candidates_blocked_by_reason: {'negative_after_cost_edge': 201, 'depth_insufficient_for_1usd': 24, 'stale_book': 13}
- paper_relaxed_best_reject_example: {'group_id': 'binary:event:36173', 'group_type': 'binary_yes_no', 'after_cost_edge': -0.003502, 'reject_reason': 'negative_after_cost_edge', 'depth_for_1usd': 79.3257, 'n_legs': 2}
- bregman_false_incomplete_family_count: 0 near_miss_promoted=0
- bregman_incomplete_family_examples: [{'group_id': 'event:event:548813', 'n_legs_scanned': 4, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:351756', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:255195', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:34051', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:139507', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:574642', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:44955', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:386788', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}]
- accelerated_discovery_enabled: True
- markets_scanned_per_tick: 1715 candidates_evaluated_per_tick=556 shadow_labels_per_tick=150 no_trade_labels_per_tick=556
- near_miss_records_written: 556 bregman_diagnostics_records_written=556
- top_near_miss_edges_after_cost: [0.999, 0.999, 0.999, 0.999, 0.999, 0.999, 0.998, 0.998, 0.998, 0.997]
- top_bregman_rejection_reasons: [{'reason': 'not_exhaustive', 'count': 204}, {'reason': 'no_positive_edge', 'count': 120}, {'reason': 'depth_too_thin', 'count': 112}, {'reason': 'stale_book', 'count': 103}, {'reason': 'invalid_simplex', 'count': 16}, {'reason': 'spread_too_wide', 'count': 1}]
- report_buckets: {'realistic_executable_trades': 0, 'bregman_certified_bundles': 0, 'directional_exploit_trades': 0, 'shadow_exploration': 0, 'no_trade_labels': 556, 'near_miss_rejects': 556, 'paper_relaxed_exploration_trades': 0}
...
- market_quality_tier_counts: {'gold': 0, 'silver': 0, 'bronze': 814, 'watch': 726, 'reject_or_diagnostic': 175}
- market_quality_score_distribution: {'0.8+': 0, '0.6-0.8': 0, '0.4-0.6': 827, '0.2-0.4': 834, '<0.2': 54}
- targeted_scan_budget_by_category: {'short_resolution': 901, 'btc_eth_chainlink': 127, 'fed_macro_reference': 42, 'high_volume_news_linked': 1, 'broad_exploration': 593}
- targeted_scan_markets_by_category: {'short_resolution': 1027, 'btc_eth_chainlink': 156, 'fed_macro_reference': 43, 'high_volume_news_linked': 1, 'broad_exploration': 641}
- high_liquidity_binary_markets_scanned: 128
- complete_yes_no_tight_spread_markets_scanned: 224
...
- thin_depth_scan_waste_count (KNOWN-thin only): 1710
- stale_book_scan_waste_count (KNOWN-stale only): 1715
...
- bregman_blocker: no_certified_bregman_opportunity: dominant_reject=not_exhaustive(204)
- relaxed_bregman_blocker: real_book_candidates_but_no_positive_after_cost_edge: real_book_candidates_seen=238; positive=0; best_after_cost_edge=-0.0035; best_reject={'group_id': 'binary:event:36173', 'group_type': 'binary_yes_no', 'after_cost_edge': -0.003502, 'reject_reason': 'negative_after_cost_edge', 'depth_for_1usd': 79.3257, 'n_legs': 2}
...
- metrics: present (not copied) (45079899 bytes)
- reports: copied (12519 bytes)
- training: present (not copied) (7134830294 bytes)
- micro_live_artifacts: copied (1967064 bytes)
