...
_Generated: 2026-06-17T03:11:40.385946+00:00 · PAPER ONLY · inspection/reporting only_
...
| Field | Value |
|---|---|
| chainlink_anchor_price | 66054.35593773 |
| fast_btc_price | 65796.015 |
| feed_disagreement_bps | None |
| market_stale_time_s | 2585.808 |
...
| groups_scanned_positive | OK | constraint_groups_scanned=514.0 |
...
- Paper training running: yes · runtime: 2.27 min
...
- preflight_ok: yes · scanned=2000 kept=1640
...
- chainlink_valid: yes
- chainlink_stale: no
- chainlink_age_seconds: 2585.808
- chainlink_price: 66054.35593773
...
- btc_fast_price_disagreement_bps: 39.11
...
- constraint_groups_scanned: 60
- candidate_arbitrages: 0
- certified_arbitrages: 0
- best_projected_profit_per_set: -0.02
- max_bregman_distance: 0.0
- mean_cost_per_set: 1.02
- expected_min_profit: 0.0
- near_miss_count: 10
- stage_rejections: {'adapter_failed': 0, 'certifier_no_positive_profit': 60, 'realism_fees_spread_depth': 0, 'other': 0}
  - near_miss(certifier_reached): legs=['tok0a', 'tok0b'] D(mu*||theta)=0.0 projected_profit/set=-0.02 cost/set=1.02 reason=no_positive_worst_case_profit tradeable=False
  - near_miss(certifier_reached): legs=['tok1a', 'tok1b'] D(mu*||theta)=0.0 projected_profit/set=-0.02 cost/set=1.02 reason=no_positive_worst_case_profit tradeable=False
  - near_miss(certifier_reached): legs=['tok2a', 'tok2b'] D(mu*||theta)=0.0 projected_profit/set=-0.02 cost/set=1.02 reason=no_positive_worst_case_profit tradeable=False
  - near_miss(certifier_reached): legs=['tok3a', 'tok3b'] D(mu*||theta)=0.0 projected_profit/set=-0.02 cost/set=1.02 reason=no_positive_worst_case_profit tradeable=False
  - near_miss(certifier_reached): legs=['tok4a', 'tok4b'] D(mu*||theta)=0.0 projected_profit/set=-0.02 cost/set=1.02 reason=no_positive_worst_case_profit tradeable=False
...
- near_miss_not_exhaustive_count: 222
- near_miss_stale_refresh_failed_count: 0
- near_miss_by_rejection_reason: {'depth_too_thin': 99, 'invalid_simplex': 9, 'no_executable_price': 2, 'no_positive_edge': 135, 'not_exhaustive': 222, 'spread_too_wide': 1, 'stale_book': 46}
- near_miss_learning_priority_counts (high/med/low): {'high': 80, 'medium': 326, 'low': 108}
- near_miss_shadow_label_candidate_count: 80
- near_miss_learning_label_counts: {'needs_multiple_fixes': 279, 'no_positive_after_cost_edge': 135, 'would_certify_if_book_fresh': 4, 'would_certify_if_depth_sufficient': 95, 'would_certify_if_spread_tightens': 1}
  - learn: binary:event:107726 priority=high(1.0) label=would_certify_if_depth_sufficient shadow_candidate=True would_trade_if=worst-leg depth $5.8337 reaches required $25.0 (thin legs=1)
  - learn: binary:event:261273 priority=high(1.0) label=would_certify_if_depth_sufficient shadow_candidate=True would_trade_if=worst-leg depth $12.0034 reaches required $25.0 (thin legs=1)
  - learn: binary:event:147609 priority=high(1.0) label=would_certify_if_depth_sufficient shadow_candidate=True would_trade_if=worst-leg depth $9.8 reaches required $25.0 (thin legs=1)
  - learn: binary:event:304330 priority=high(1.0) label=would_certify_if_depth_sufficient shadow_candidate=True would_trade_if=worst-leg depth $12.48 reaches required $25.0 (thin legs=1)
  - learn: binary:event:569695 priority=high(1.0) label=would_certify_if_depth_sufficient shadow_candidate=True would_trade_if=worst-leg depth $16.8678 reaches required $25.0 (thin legs=1)

### 11b. Bregman Price/Outcome Parsing + Depth Census (read-only)

- non_numeric_price_count: 0
- insufficient_outcomes_count: 0
- malformed_group_count: 280868
- parsed_price_success_rate: 1.0
- bregman_depth_sufficient_groups: 141
- bregman_depth_insufficient_groups: 373
- bregman_high_liquidity_groups_scanned: 96
- bregman_all_groups_thin: False
- complete_set_count (certified): 0
- incomplete_set_count (not_exhaustive near-misses): 222
...
- bregman_groups_entered_certifier: 514
...
- bregman_real_market_zero_candidate_reason_counts: {'depth_too_thin': 99, 'invalid_simplex': 9, 'no_executable_price': 2, 'no_positive_edge': 135, 'not_exhaustive': 222, 'spread_too_wide': 1, 'stale_book': 46}
- bregman_depth_sufficient_groups: 141
- bregman_depth_sufficient_but_negative_edge_count: 141
- bregman_best_depth_sufficient_group_lower_bound: -0.001
- bregman_best_depth_sufficient_group_reject_reason: no_positive_edge
- best_real_group: binary:event:108634 depth_sufficient=True min_leg_depth=$102.6569 (required $25.0) reject=no_positive_edge lower_bound=-0.001 market_ids=['958443'] labels=['YES', 'NO']
...
- malformed_group_count (reconciled): 280868
- bregman_malformed_group_reported_count (trainer certifier): 0
- bregman_malformed_group_runtime_count (ABCAS scanner): 0
- bregman_malformed_group_tail_count (diagnostics tail): 280868
- bregman_malformed_group_legacy_or_tail_only_count: 280868
- source: abcas_scanner_path_real_rejects

### 11d-stage. Trainer Certifier Per-Stage Census (read-only)

- bregman_rejection_stage_counts: {'edge': 135, 'realism': 148, 'validate_simplex': 231}
- bregman_max_divergence_gap (D(mu*||theta)): 11.5441581
- bregman_best_projected_lower_bound: 0.999
- bregman_positive_projected_but_rejected_count: 138
- bregman_positive_projected_rejected_by_stage: {'realism': 9, 'validate_simplex': 129}
- WHY certified=0: dominant stage=validate_simplex: groups are structurally INCOMPLETE (exhaustive=False / not a provable complete set) — buying a partial set is not a guaranteed hedge, so it is correctly NOT certified (completeness is never fabricated); NOTE: 138 group(s) had POSITIVE raw projected profit (best=0.999) but were still rejected (realism=9, validate_simplex=129) — the raw mispricing is real, but the set is not a certifiable complete hedge
- profit_lower_bound (min/mean/max): -14.993 / -0.001868 / 0.999
- groups by lower_bound sign (neg/zero/pos): 373 / 3 / 138
  ...
  - group: event:event:548813 exhaustive=False settlement_consistent=False profit_lower_bound=-0.44 divergence_gap=0.06453333 reason=not_exhaustive
  ...
  - group: binary:event:579960 exhaustive=True settlement_consistent=True profit_lower_bound=0.999 divergence_gap=0.4990005 reason=no_executable_price
  - group: binary:event:579959 exhaustive=True settlement_consistent=True profit_lower_bound=-0.001 divergence_gap=5e-07 reason=stale_book
  ...
  - near_miss: binary:event:574642 stage=edge exhaustive=True settlement_consistent=True divergence_gap=5e-07 projected_lb=-0.001 reason=no_positive_edge
  - near_miss: binary:event:46844 stage=edge exhaustive=True settlement_consistent=True divergence_gap=2e-06 projected_lb=-0.002 reason=no_positive_edge
...
- bandit_action_rewards: {'bregman_depth_watchlist': 0.0, 'bregman_not_exhaustive_completer': 0.0, 'bregman_rebalancing_watchlist': 0.0, 'grok_news_linked_near_miss': 0.0, 'active_learning_shadow': 0.0}
...
- targeted_markets_scanned_total: 1640
- targeted_scan_field_source: bregman_normalized_groups+raw_records
- targeted_scan_bregman_groups_seen: 514
- targeted_scan_binary_groups_seen: 287
- targeted_scan_yes_no_pairs_seen: 283
- targeted_scan_binary_group_matches: 287 raw_market_matches=1631
- targeted_scan_bregman_categories: {'complete_yes_no_tight_spread': 230, 'high_liquidity_binary': 140}
- targeted_scan_raw_market_categories: {'short_resolution': 998, 'btc_eth_chainlink': 139, 'fed_macro_reference': 32, 'high_volume_news_linked': 1}
- targeted_scan_normalized_reject_reasons: {'depth_too_thin': 99, 'not_exhaustive': 222, 'no_executable_price': 2, 'stale_book': 46, 'no_positive_edge': 135, 'invalid_simplex': 9, 'spread_too_wide': 1}
...
- bregman_clob_hydration_eligible_groups: 514 selected=250 coverage_rate=0.4864
...
- paper_relaxed_after_cost_positive_seen: 0 real_clob_book_seen=236
- paper_relaxed_readiness_pnl_excluded: True
- paper_relaxed_pipeline_scanned: 514
- paper_relaxed_real_book_candidates_seen: 236 positive=0
- paper_relaxed_candidate_source_counts: {'binary_yes_no': 236}
- paper_relaxed_candidates_blocked_by_reason: {'negative_after_cost_edge': 205, 'depth_insufficient_for_1usd': 26, 'stale_book': 5}
- paper_relaxed_best_reject_example: {'group_id': 'binary:event:108634', 'group_type': 'binary_yes_no', 'after_cost_edge': -0.003502, 'reject_reason': 'negative_after_cost_edge', 'depth_for_1usd': 102.6569, 'n_legs': 2}
- bregman_false_incomplete_family_count: 0 near_miss_promoted=0
- bregman_incomplete_family_examples: [{'group_id': 'event:event:548813', 'n_legs_scanned': 3, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:36173', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:386812', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:34051', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:386788', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:139507', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:255195', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:106811', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}]
- accelerated_discovery_enabled: True
- markets_scanned_per_tick: 1640 candidates_evaluated_per_tick=514 shadow_labels_per_tick=150 no_trade_labels_per_tick=514
- near_miss_records_written: 514 bregman_diagnostics_records_written=514
- top_near_miss_edges_after_cost: [0.999, 0.999, 0.999, 0.999, 0.999, 0.999, 0.999, 0.998, 0.998, 0.997]
- top_bregman_rejection_reasons: [{'reason': 'not_exhaustive', 'count': 222}, {'reason': 'no_positive_edge', 'count': 135}, {'reason': 'depth_too_thin', 'count': 99}, {'reason': 'stale_book', 'count': 46}, {'reason': 'invalid_simplex', 'count': 9}, {'reason': 'no_executable_price', 'count': 2}, {'reason': 'spread_too_wide', 'count': 1}]
- report_buckets: {'realistic_executable_trades': 0, 'bregman_certified_bundles': 0, 'directional_exploit_trades': 0, 'shadow_exploration': 0, 'no_trade_labels': 514, 'near_miss_rejects': 514, 'paper_relaxed_exploration_trades': 0}
...
- market_quality_tier_counts: {'gold': 0, 'silver': 0, 'bronze': 716, 'watch': 706, 'reject_or_diagnostic': 218}
- market_quality_score_distribution: {'0.8+': 0, '0.6-0.8': 0, '0.4-0.6': 725, '0.2-0.4': 857, '<0.2': 58}
- targeted_scan_budget_by_category: {'short_resolution': 830, 'btc_eth_chainlink': 116, 'fed_macro_reference': 32, 'broad_exploration': 550}
- targeted_scan_markets_by_category: {'short_resolution': 998, 'btc_eth_chainlink': 139, 'fed_macro_reference': 32, 'high_volume_news_linked': 1, 'broad_exploration': 599}
- high_liquidity_binary_markets_scanned: 140
- complete_yes_no_tight_spread_markets_scanned: 230
- negative_risk_complete_events_scanned: 0
- short_resolution_markets_scanned: 998
- btc_eth_chainlink_markets_scanned: 139
- fed_macro_reference_markets_scanned: 32
- high_volume_news_linked_markets_scanned: 1
- complete_event_families_scanned: 0
- thin_depth_scan_waste_count (KNOWN-thin only): 1637
- stale_book_scan_waste_count (KNOWN-stale only): 1640
...
- targeted_scan_noop_reasons: {'negative_risk_complete': '0/1640 markets carried negRiskComplete/outcomeCount metadata proving a complete event family (completeness is never inferred from titles)', 'complete_event_family': '0/1640 markets carried negRiskComplete/outcomeCount metadata proving a complete event family (completeness is never inferred from titles)', 'thin_depth_deprioritized': '0/1640 markets matched thin_depth_deprioritized (binaries seen=287)', 'stale_book_refresh': '0/1640 markets matched stale_book_refresh (binaries seen=287)'}
  - best: 2412404 tier=bronze score=0.544464 categories=['short_resolution']
  - best: 2492104 tier=bronze score=0.510864 categories=['short_resolution', 'btc_eth_chainlink']
  - best: 2492099 tier=bronze score=0.510864 categories=['short_resolution', 'btc_eth_chainlink']
...
- bregman_blocker: no_certified_bregman_opportunity: dominant_reject=not_exhaustive(222)
- relaxed_bregman_blocker: real_book_candidates_but_no_positive_after_cost_edge: real_book_candidates_seen=236; positive=0; best_after_cost_edge=-0.0035; best_reject={'group_id': 'binary:event:108634', 'group_type': 'binary_yes_no', 'after_cost_edge': -0.003502, 'reject_reason': 'negative_after_cost_edge', 'depth_for_1usd': 102.6569, 'n_legs': 2}
...
- paper_trade_acceleration_blocker_if_any: no_paper_trade_opened_in_any_lane: bregman=no_certified_bregman_opportunity: dominant_reject=not_exhaustive(222); relaxed_bregman=real_book_candidates_but_no_positive_after_cost_edge: real_book_candidates_seen=236; positive=0; best_after_cost_edge=-0.0035; best_reject={'group_id': 'binary:event:108634', 'group_type': 'binary_yes_no', 'after_cost_edge': -0.003502, 'reject_reason': 'negative_after_cost_edge', 'depth_for_1usd': 102.6569, 'n_legs': 2}; tiny_directional=no_active_learning_tiny_selection: exploration_enabled=True; active_learning_enabled=True; btc_pulse=btc_pulse_disabled
...
- metrics: present (not copied) (60902768 bytes)
- reports: copied (12901 bytes)
- training: present (not copied) (8038447409 bytes)
- micro_live_artifacts: copied (2950596 bytes)
