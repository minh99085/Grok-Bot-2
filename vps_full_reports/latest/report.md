...
_Generated: 2026-06-20T12:29:03.048447+00:00 · PAPER ONLY · inspection/reporting only_
...
| Field | Value |
|---|---|
| constraint_groups_scanned | 485.0 |
| raw_groups_discovered | 485.0 |
| incoherent_groups | 0.0 |
| candidate_arbitrages | 0.0 |
| certified_arbitrages | 0.0 |
| executable_depth_certified | 0.0 |
| rejected_fees_spread_depth_slippage | 41290 |
...
| Field | Value |
|---|---|
| chainlink_anchor_price | 63646.28069904 |
| fast_btc_price | 63682.275 |
| feed_disagreement_bps | None |
| market_stale_time_s | 1748.972 |
...
| groups_scanned_positive | OK | constraint_groups_scanned=485.0 |
...
- Paper training running: yes · runtime: 395.49 min
...
- preflight_ok: yes · scanned=2000 kept=1746
...
- chainlink_valid: yes
- chainlink_stale: no
- chainlink_age_seconds: 1748.972
- chainlink_price: 63646.28069904
...
- btc_fast_price_disagreement_bps: 5.655
...
- news_items_fetched: 7149
- news_items_used: 3260
...
- grok_calls_total: 151
- grok_calls_with_news: 151
- grok_proof_calls_total: 0
- grok_scheduler_calls_total: 151
- grok_total_calls_reconciled: True
- grok_scheduled_calls: 151
- grok_scheduler_eligible_targets: 907
- grok_scheduler_targets_selected: 151
- grok_scheduler_targets_skipped: 0
- grok_scheduler_skip_reasons: {}
- grok_advisory_only_count: 151
- grok_evidence_records_written: 151
- grok_advisory_max_calls_per_hour: 30
- grok_advisory_calls_per_hour: 22
- grok_market_groups_analyzed: 150
- grok_bregman_near_misses_analyzed: 150
- grok_bregman_incomplete_groups_analyzed: 49
- grok_bregman_malformed_groups_analyzed: 3
- grok_news_linked_markets_analyzed: 58
- grok_learning_features_written: 151
...
- constraint_groups_scanned: 747
- candidate_arbitrages: 0
- certified_arbitrages: 0
- best_projected_profit_per_set: 0.0
- max_bregman_distance: 0.0
- mean_cost_per_set: 1.011329
- expected_min_profit: 0.0
- near_miss_count: 10
- stage_rejections: {'adapter_failed': 1486, 'certifier_no_positive_profit': 747, 'realism_fees_spread_depth': 0, 'other': 0}
...
- bregman_near_misses_total: 896
- near_miss_one_fix_away_count: 172
- near_miss_depth_only_count: 171
- near_miss_not_exhaustive_count: 303
- near_miss_stale_refresh_failed_count: 0
- near_miss_by_rejection_reason: {'depth_too_thin': 118, 'no_executable_price': 3, 'no_positive_edge': 404, 'not_exhaustive': 303, 'spread_too_wide': 2, 'stale_book': 66}
- near_miss_learning_priority_counts (high/med/low): {'high': 134, 'medium': 678, 'low': 84}
- near_miss_shadow_label_candidate_count: 134
- near_miss_learning_label_counts: {'needs_multiple_fixes': 388, 'no_positive_after_cost_edge': 336, 'would_certify_if_depth_sufficient': 171, 'would_certify_if_valid_simplex': 1}
  - learn: binary:event:169319 priority=high(1.0) label=would_certify_if_depth_sufficient shadow_candidate=True would_trade_if=worst-leg depth $7.3146 reaches required $25.0 (thin legs=1)
  - learn: binary:event:147609 priority=high(1.0) label=would_certify_if_depth_sufficient shadow_candidate=True would_trade_if=worst-leg depth $21.61 reaches required $25.0 (thin legs=1)
  - learn: binary:event:206998 priority=high(1.0) label=would_certify_if_depth_sufficient shadow_candidate=True would_trade_if=worst-leg depth $18.0061 reaches required $25.0 (thin legs=1)
  - learn: binary:event:73042 priority=high(1.0) label=would_certify_if_depth_sufficient shadow_candidate=True would_trade_if=worst-leg depth $8.9515 reaches required $25.0 (thin legs=1)
  - learn: binary:event:608767 priority=high(1.0) label=would_certify_if_depth_sufficient shadow_candidate=True would_trade_if=worst-leg depth $13.4495 reaches required $25.0 (thin legs=1)

### 11b. Bregman Price/Outcome Parsing + Depth Census (read-only)

- non_numeric_price_count: 0
- insufficient_outcomes_count: 0
- malformed_group_count: 337991
- parsed_price_success_rate: 1.0
- bregman_depth_sufficient_groups: 120
- bregman_depth_insufficient_groups: 365
- bregman_high_liquidity_groups_scanned: 77
- bregman_all_groups_thin: False
- complete_set_count (certified): 0
- incomplete_set_count (not_exhaustive near-misses): 303
- bregman_promising_groups_refreshed: 0
- bregman_refresh_success: 0 failed: 0 stale_after: 6
...
Top Bregman near-misses (diagnostic only — NOT executed):
  ...
  - event:event:609510 reason=no_positive_edge score=0.9 market_ids=['2599194', '2599196', '2599197', '2599198', '2599199', '2599200', '2599201', '2599202', '2599203', '2599204', '2599205'] token_ids=<REDACTED> '<REDACTED>', '<REDACTED>', '<REDACTED>', '<REDACTED>', '<REDACTED>', '<REDACTED>', '<REDACTED>', '<REDACTED>', '<REDACTED>', '<REDACTED>'] labels=['YES', 'YES', 'YES', 'YES', 'YES', 'YES', 'YES', 'YES', 'YES', 'YES', 'YES'] one_fix_away=True tradeable=False blockers=['invalid_simplex']
...
- bregman_groups_entered_certifier: 485
...
- bregman_real_market_zero_candidate_reason_counts: {'depth_too_thin': 71, 'no_executable_price': 4, 'no_positive_edge': 144, 'not_exhaustive': 223, 'stale_book': 43}
- bregman_depth_sufficient_groups: 120
- bregman_depth_sufficient_but_negative_edge_count: 120
- bregman_best_depth_sufficient_group_lower_bound: -0.001
- bregman_best_depth_sufficient_group_reject_reason: no_positive_edge
- best_real_group: binary:event:255195 depth_sufficient=True min_leg_depth=$122.3685 (required $25.0) reject=no_positive_edge lower_bound=-0.001 market_ids=['1708133'] labels=['YES', 'NO']
  - sample: group=event:event:551781 reason=not_exhaustive depth_sufficient=True market_ids=['2419331', '2419337', '2419341', '2419348', '2419350', '2419351', '2419355', '2419359', '2419361'] token_ids=<REDACTED> '<REDACTED>', '<REDACTED>', '<REDACTED>', '<REDACTED>', '<REDACTED>', '<REDACTED>', '<REDACTED>', '<REDACTED>'] labels=['YES', 'YES', 'YES', 'YES', 'YES', 'YES', 'YES', 'YES', 'YES']
...
- best_one_fix_away_reason: invalid_simplex
- all_top_near_misses_negative_lower_bound: True

### 11d. Malformed-Group Reconciliation (summary vs tail)

- malformed_group_count (reconciled): 337991
- bregman_malformed_group_reported_count (trainer certifier): 0
- bregman_malformed_group_runtime_count (ABCAS scanner): 466
- bregman_malformed_group_tail_count (diagnostics tail): 337991
- bregman_malformed_group_legacy_or_tail_only_count: 337525
- source: abcas_scanner_path_real_rejects

### 11d-stage. Trainer Certifier Per-Stage Census (read-only)

- bregman_rejection_stage_counts: {'edge': 144, 'realism': 118, 'validate_simplex': 223}
- bregman_max_divergence_gap (D(mu*||theta)): 10.9226861
- bregman_best_projected_lower_bound: 0.999
- bregman_positive_projected_but_rejected_count: 102
- bregman_positive_projected_rejected_by_stage: {'realism': 14, 'validate_simplex': 88}
- WHY certified=0: dominant stage=validate_simplex: groups are structurally INCOMPLETE (exhaustive=False / not a provable complete set) — buying a partial set is not a guaranteed hedge, so it is correctly NOT certified (completeness is never fabricated); NOTE: 102 group(s) had POSITIVE raw projected profit (best=0.999) but were still rejected (realism=14, validate_simplex=88) — the raw mispricing is real, but the set is not a certifiable complete hedge
- profit_lower_bound (min/mean/max): -13.807 / -0.197476 / 0.999
- groups by lower_bound sign (neg/zero/pos): 382 / 1 / 102
  - group: event:event:551781 exhaustive=False settlement_consistent=False profit_lower_bound=-0.27 divergence_gap=0.00836514 reason=not_exhaustive
  - group: event:event:548813 exhaustive=False settlement_consistent=False profit_lower_bound=-0.65 divergence_gap=0.11605 reason=not_exhaustive
  - group: event:event:36173 exhaustive=False settlement_consistent=False profit_lower_bound=0.948 divergence_gap=0.449352 reason=not_exhaustive
  - group: binary:event:255195 exhaustive=True settlement_consistent=True profit_lower_bound=-0.001 divergence_gap=5e-07 reason=no_positive_edge
  - group: binary:event:108639 exhaustive=True settlement_consistent=True profit_lower_bound=-0.001 divergence_gap=5e-07 reason=no_positive_edge
  - near_miss: event:event:609510 stage=edge exhaustive=True settlement_consistent=True divergence_gap=1.30649 projected_lb=-3.79 reason=no_positive_edge
  ...
  - near_miss: binary:event:261273 stage=edge exhaustive=True settlement_consistent=True divergence_gap=2e-06 projected_lb=-0.002 reason=no_positive_edge
...
- bregman_shadow_label_candidates: 134
- bregman_shadow_labels_written: 209
- bregman_shadow_label_write_rate: 1.5597
- shadow_records_written: 37399
- shadow_labels_tail_nonempty: True
- shadow_label_write_rejection_reasons: {'already_written': 15633}
- profit_discovery_queue_items: 896
- profit_discovery_queue_by_priority: {'2': 171, '3': 285, '5': 440}
- profit_learning_status: shadow_data_only
- profit_data_sufficiency: sufficient
- bandit_router_enabled: True
- bandit_action_counts: {'bregman_depth_watchlist': 28, 'bregman_not_exhaustive_completer': 5, 'bregman_rebalancing_watchlist': 5, 'grok_news_linked_near_miss': 63, 'active_learning_shadow': 51}
- bandit_action_rewards: {'bregman_depth_watchlist': 69.0, 'bregman_not_exhaustive_completer': 0.0, 'bregman_rebalancing_watchlist': 0.0, 'grok_news_linked_near_miss': 63.0, 'active_learning_shadow': 48.0}
...
- targeted_markets_scanned_total: 1815
- targeted_scan_field_source: bregman_normalized_groups+raw_records
- targeted_scan_bregman_groups_seen: 896
- targeted_scan_binary_groups_seen: 575
- targeted_scan_yes_no_pairs_seen: 575
- targeted_scan_binary_group_matches: 320 raw_market_matches=1739
- targeted_scan_bregman_categories: {'high_liquidity_binary': 322, 'complete_yes_no_tight_spread': 493, 'negative_risk_complete': 18, 'complete_event_family': 18}
- targeted_scan_raw_market_categories: {'high_liquidity_binary': 2, 'complete_yes_no_tight_spread': 2, 'negative_risk_complete': 326, 'short_resolution': 1214, 'btc_eth_chainlink': 122, 'fed_macro_reference': 26, 'high_volume_news_linked': 1, 'complete_event_family': 326}
- targeted_scan_normalized_reject_reasons: {'not_exhaustive': 303, 'stale_book': 66, 'no_positive_edge': 404, 'depth_too_thin': 118, 'spread_too_wide': 2, 'no_executable_price': 3}
- bregman_clob_hydration_enabled: True
- bregman_clob_hydration_attempted: 250 success=225 failed=25
- bregman_real_yes_no_books_seen: 482
- bregman_certifier_used_real_clob_books: True
- bregman_synthetic_no_diagnostic_only_count: 15
- bregman_hydration_failure_reasons: {'no_book_or_no_ask': 32}
- bregman_clob_hydration_eligible_groups: 485 selected=250 coverage_rate=0.5155
- paper_trade_pressure_enabled: True
- paper_micro_exploration_enabled: True
- paper_micro_exploration_candidates: 2 trades=0
- hydrated_positive_after_cost_candidates: 0
- realistic_trade_goal_met_11h: True
- paper_micro_exploration_reject_reasons: {'bregman_leg_stale_book': 2}
- paper_relaxed_exploration_enabled: True (max_notional=1.0 per_hour=3 per_day=30)
- paper_relaxed_candidates_seen: 2 trades_opened=0
- paper_relaxed_after_cost_positive_seen: 2 real_clob_book_seen=35227
- paper_relaxed_readiness_pnl_excluded: True
- paper_relaxed_reject_reasons: {'bregman_leg_stale_book': 2}
- paper_relaxed_pipeline_scanned: 78265
- paper_relaxed_real_book_candidates_seen: 35227 positive=2
- paper_relaxed_candidate_source_counts: {'binary_yes_no': 33994, 'exhaustive_event': 1233}
- paper_relaxed_candidates_blocked_by_reason: {'negative_after_cost_edge': 29684, 'stale_book': 2487, 'depth_insufficient_for_1usd': 3054}
- paper_relaxed_best_real_book_candidate: {'group_id': 'binary:event:611592', 'group_type': 'binary_yes_no', 'after_cost_edge': 0.05765, 'reject_reason': '', 'depth_for_1usd': 1.47, 'n_legs': 2}
- paper_relaxed_best_reject_example: {'group_id': 'binary:event:607414', 'group_type': 'binary_yes_no', 'after_cost_edge': -0.0025, 'reject_reason': 'negative_after_cost_edge', 'depth_for_1usd': 2.4, 'n_legs': 2}
- bregman_false_incomplete_family_count: 0 near_miss_promoted=0
- bregman_incomplete_family_examples: [{'group_id': 'event:event:551781', 'n_legs_scanned': 9, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:548813', 'n_legs_scanned': 4, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:36173', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:386812', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:106811', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:386788', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:608804', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:386759', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}]
- bregman_missing_outcome_examples: [{'group_id': 'event:event:577376', 'present_outcomes_sample': ['Will Iran close its airspace by June 30?', 'Will Iran close its airspace by July 31?', 'Will Iran close its airspace by December 31?', 'Will Iran close its airspace by June 10?', 'Will Iran close its airspace by June 12?', 'Will Iran close its airspace by June 11?'], 'missing_outcome_count': 1}, {'group_id': 'event:negrisk:<REDACTED>', 'present_outcomes_sample': ['Will Tereza Cristina win the 2026 Brazilian presidential election?', 'Will Eduardo Leite win the 2026 Brazilian presidential election?', 'Will Eduardo Bolsonaro win the 2026 Brazilian presidential election?', 'Will Michelle Bolsonaro win the 2026 Brazilian presidential election?', 'Will Geraldo Alckmin win the 2026 Brazilian presidential election?', 'Will Tarcisio de Freitas win the 2026 Brazilian presidential election?'], 'missing_outcome_count': 7}, {'group_id': 'event:negrisk:<REDACTED>', 'present_outcomes_sample': ["Will Alexander Albon be the 2026 F1 Drivers' Champion?", "Will Charles Leclerc be the 2026 F1 Drivers' Champion?", "Will Carlos Sainz Jr. be the 2026 F1 Drivers' Champion?", "Will Oliver Bearman be the 2026 F1 Drivers' Champion?", "Will Gabriel Bortoleto be the 2026 F1 Drivers' Champion?", "Will Isack Hadjar be the 2026 F1 Drivers' Champion?"], 'missing_outcome_count': 3}, {'group_id': 'event:negrisk:<REDACTED>', 'present_outcomes_sample': ['Will Donald Trump Jr. win the 2028 Republican presidential nomination?', 'Will Marco Rubio win the 2028 Republican presidential nomination?', 'Will J.D. Vance win the 2028 Republican presidential nomination?', 'Will Thomas Massie win the 2028 Republican presidential nomination?', 'Will Mike Pence win the 2028 Republican presidential nomination?', 'Will Ron DeSantis win the 2028 Republican presidential nomination?'], 'missing_outcome_count': 85}, {'group_id': 'event:negrisk:<REDACTED>', 'present_outcomes_sample': ['Will Jalen Brunson win the 2028 US Presidential Election?', 'Will Michelle Obama win the 2028 US Presidential Election?', 'Will LeBron James win the 2028 US Presidential Election?', 'Will Greg Abbott win the 2028 US Presidential Election?', 'Will JD Vance win the 2028 US Presidential Election?', 'Will Josh Shapiro win the 2028 US Presidential Election?'], 'missing_outcome_count': 83}, {'group_id': 'event:negrisk:<REDACTED>', 'present_outcomes_sample': ['Will Mark Kelly win the 2028 Democratic presidential nomination?', 'Will J.B. Pritzker win the 2028 Democratic presidential nomination?', 'Will Jon Ossoff win the 2028 Democratic presidential nomination?', 'Will George Clooney win the 2028 Democratic presidential nomination?', 'Will John Fetterman win the 2028 Democratic presidential nomination?', 'Will Raphael Warnock win the 2028 Democratic presidential nomination?'], 'missing_outcome_count': 75}, {'group_id': 'event:negrisk:<REDACTED>', 'present_outcomes_sample': ['Will Czechia win the 2026 FIFA World Cup?', 'Will Bosnia-Herzegovina win the 2026 FIFA World Cup?', 'Will Congo DR win the 2026 FIFA World Cup?', 'Will Sweden win the 2026 FIFA World Cup?', 'Will Croatia win the 2026 FIFA World Cup?', 'Will Austria win the 2026 FIFA World Cup?'], 'missing_outcome_count': 6}, {'group_id': 'event:negrisk:<REDACTED>', 'present_outcomes_sample': ['Will Memphis Depay be the top goalscorer at the 2026 FIFA World Cup?', 'Will Cody Gakpo be the top goalscorer at the 2026 FIFA World Cup?', 'Will Desire Doue be the top goalscorer at the 2026 FIFA World Cup?', 'Will Kai Havertz be the top goalscorer at the 2026 FIFA World Cup?', 'Will Raphinha be the top goalscorer at the 2026 FIFA World Cup?', 'Will Bruno Fernandes be the top goalscorer at the 2026 FIFA World Cup?'], 'missing_outcome_count': 24}]
- accelerated_discovery_enabled: True
- markets_scanned_per_tick: 1815 candidates_evaluated_per_tick=485 shadow_labels_per_tick=150 no_trade_labels_per_tick=485
- near_miss_records_written: 896 bregman_diagnostics_records_written=78265
- top_near_miss_edges_after_cost: [0.999, 0.999, 0.999, 0.999, 0.999, 0.999, 0.999, 0.999, 0.999, 0.999]
- top_bregman_rejection_reasons: [{'reason': 'not_exhaustive', 'count': 36584}, {'reason': 'no_positive_edge', 'count': 21943}, {'reason': 'depth_too_thin', 'count': 11739}, {'reason': 'stale_book', 'count': 7579}, {'reason': 'no_executable_price', 'count': 390}, {'reason': 'spread_too_wide', 'count': 29}, {'reason': 'bregman_leg_stale_book', 'count': 3}]
- report_buckets: {'realistic_executable_trades': 2, 'bregman_certified_bundles': 0, 'directional_exploit_trades': 2, 'shadow_exploration': 0, 'no_trade_labels': 485, 'near_miss_rejects': 896, 'paper_relaxed_exploration_trades': 0}
...
- market_quality_tier_counts: {'gold': 0, 'silver': 2, 'bronze': 796, 'watch': 737, 'reject_or_diagnostic': 280}
- market_quality_score_distribution: {'0.8+': 0, '0.6-0.8': 2, '0.4-0.6': 805, '0.2-0.4': 929, '<0.2': 79}
- targeted_scan_budget_by_category: {'high_liquidity_binary': 6, 'complete_yes_no_tight_spread': 6, 'negative_risk_complete': 252, 'short_resolution': 1011, 'btc_eth_chainlink': 99, 'fed_macro_reference': 26, 'high_volume_news_linked': 1, 'complete_event_family': 252, 'broad_exploration': 329}
- targeted_scan_markets_by_category: {'high_liquidity_binary': 2, 'complete_yes_no_tight_spread': 2, 'negative_risk_complete': 326, 'short_resolution': 1214, 'btc_eth_chainlink': 122, 'fed_macro_reference': 26, 'high_volume_news_linked': 1, 'complete_event_family': 326, 'broad_exploration': 362}
- high_liquidity_binary_markets_scanned: 324
- complete_yes_no_tight_spread_markets_scanned: 495
- negative_risk_complete_events_scanned: 344
- short_resolution_markets_scanned: 1214
- btc_eth_chainlink_markets_scanned: 122
- fed_macro_reference_markets_scanned: 26
- high_volume_news_linked_markets_scanned: 1
- complete_event_families_scanned: 344
- thin_depth_scan_waste_count (KNOWN-thin only): 1802
- stale_book_scan_waste_count (KNOWN-stale only): 1812
- targeted_scan_missing_data_counts (NOT waste): {'missing_book_timestamp': 0, 'missing_depth': 13, 'missing_volume': 7}
- scan_deprioritized_groups: 12 cooldown_active=1913 reasons={'invalid_simplex': 1, 'stale_book': 12, 'thin_depth': 12}
- not_exhaustive_high_quality_groups: 0 (sibling=0 grok=0 shadow_only=0)
- targeted_scan_noop_reasons: {'thin_depth_deprioritized': '0/1815 markets matched thin_depth_deprioritized (binaries seen=575)', 'stale_book_refresh': '0/1815 markets matched stale_book_refresh (binaries seen=575)'}
  - best: 2419359 tier=silver score=0.70582 categories=['high_liquidity_binary', 'complete_yes_no_tight_spread', 'short_resolution']
  - best: 2412403 tier=silver score=0.691355 categories=['high_liquidity_binary', 'complete_yes_no_tight_spread', 'short_resolution']
  - best: 2412401 tier=bronze score=0.547852 categories=['short_resolution']
...
- active_learning_tiny_trades_selected: 2
- active_learning_tiny_trades_opened: 2
...
- bregman_blocker: no_certified_bregman_opportunity: dominant_reject=not_exhaustive(36584)
...
- profitability_buckets: {'exploration_feedback_positive': 2}
...
- Tiny evaluator called: 2
- Tiny candidates evaluated: 2
- Tiny trades selected: 2
- Tiny trades opened: 2
...
- Legacy random exploration blocked: 500
- Exploration counted toward readiness: no (should be false)
- Exploration consumes Bregman reserved capacity: no (should be false)
- active_learning_candidates_considered: 808
- active_learning_candidates_selected: 808
- exploration_trades_opened: 2
- exploration_shadow_only: 1205
- exploration_rejected_by_realism: 0
- exploration_rejected_by_budget: 0
- exploration_rejected_by_collision: 0
- exploration_rejected_by_diversity: 0
- exploration_budget_used_usd: 16.0
- exploration_expected_loss_usd: 0.3
- exploration_pnl: -0.5273
- avg_active_learning_score_selected: 1.436623
- avg_execution_quality_selected: 0.71225
- top_learning_buckets: ['calibration_gap_bucket', 'model_uncertain_high_liquidity']
- category_coverage: {'uncategorized': 2}
- pending_feedback_count: 0
- completed_feedback_count: 2
...
- size_capped_by_cluster_exposure: 2
...
- metrics: present (not copied) (112337979 bytes)
- reports: copied (13993 bytes)
- training: present (not copied) (10587039243 bytes)
- micro_live_artifacts: copied (8047080 bytes)
...
| win_rate_traded_only | 0.0 | 0.5 | higher | FAIL | Win rate over traded-only paper decisions. |
...
| max_drawdown | -0.5273 | 0.15 | lower | PASS | Max drawdown (fraction of equity). |
