...
_Generated: 2026-06-19T04:31:07.964281+00:00 · PAPER ONLY · inspection/reporting only_
...
| Field | Value |
|---|---|
| chainlink_anchor_price | 62815.92326051 |
| fast_btc_price | 62672.015 |
| feed_disagreement_bps | None |
| market_stale_time_s | 694.123 |
...
| groups_scanned_positive | OK | constraint_groups_scanned=488.0 |
...
- Paper training running: yes · runtime: 6.42 min
...
- preflight_ok: yes · scanned=2000 kept=1861
...
- chainlink_valid: yes
- chainlink_stale: no
- chainlink_age_seconds: 694.123
- chainlink_price: 62815.92326051
...
- btc_fast_price_disagreement_bps: 22.91
...
- grok_scheduler_eligible_targets: 505
- grok_scheduler_targets_selected: 1
- grok_scheduler_targets_skipped: 1
- grok_scheduler_skip_reasons: {'not_due_yet': 1}
...
- constraint_groups_scanned: 704
- candidate_arbitrages: 0
- certified_arbitrages: 0
- best_projected_profit_per_set: 0.0
- max_bregman_distance: 0.001
- mean_cost_per_set: 1.015259
- expected_min_profit: 0.0
- near_miss_count: 10
- stage_rejections: {'adapter_failed': 1539, 'certifier_no_positive_profit': 704, 'realism_fees_spread_depth': 0, 'other': 0}
...
- bregman_near_misses_total: 493
- near_miss_one_fix_away_count: 100
- near_miss_depth_only_count: 0
- near_miss_not_exhaustive_count: 244
- near_miss_stale_refresh_failed_count: 0
- near_miss_by_rejection_reason: {'not_exhaustive': 244, 'stale_book': 249}
- near_miss_learning_priority_counts (high/med/low): {'high': 74, 'medium': 263, 'low': 156}
- near_miss_shadow_label_candidate_count: 74
- near_miss_learning_label_counts: {'needs_multiple_fixes': 393, 'would_certify_if_book_fresh': 100}
  - learn: binary:event:261273 priority=high(1.0) label=would_certify_if_book_fresh shadow_candidate=True would_trade_if=all leg books are fresh (within 20.0s)
  - learn: binary:event:107726 priority=high(1.0) label=would_certify_if_book_fresh shadow_candidate=True would_trade_if=all leg books are fresh (within 20.0s)
  - learn: binary:event:108634 priority=high(1.0) label=would_certify_if_book_fresh shadow_candidate=True would_trade_if=all leg books are fresh (within 20.0s)
  - learn: binary:event:574642 priority=high(1.0) label=would_certify_if_book_fresh shadow_candidate=True would_trade_if=all leg books are fresh (within 20.0s)
  - learn: binary:event:211827 priority=high(1.0) label=would_certify_if_book_fresh shadow_candidate=True would_trade_if=all leg books are fresh (within 20.0s)

### 11b. Bregman Price/Outcome Parsing + Depth Census (read-only)

- non_numeric_price_count: 0
- insufficient_outcomes_count: 0
- malformed_group_count: 315795
...
- bregman_refresh_success: 0 failed: 0 stale_after: 98
...
- no_bundle_blocker: stale_books (groups reached the certifier but every one was rejected by a STRICT gate (not loosened); dominant reason above)

Top Bregman near-misses (diagnostic only — NOT executed):

  - binary:event:261273 reason=stale_book score=0.75 market_ids=['1559394'] token_ids=<REDACTED> '<REDACTED>'] labels=['YES', 'NO'] one_fix_away=True tradeable=False blockers=['stale_book']
  - binary:event:107726 reason=stale_book score=0.75 market_ids=['956590'] token_ids=<REDACTED> '<REDACTED>'] labels=['YES', 'NO'] one_fix_away=True tradeable=False blockers=['stale_book']
  - binary:event:108634 reason=stale_book score=0.75 market_ids=['958443'] token_ids=<REDACTED> '<REDACTED>'] labels=['YES', 'NO'] one_fix_away=True tradeable=False blockers=['stale_book']
  - binary:event:574642 reason=stale_book score=0.75 market_ids=['2475212'] token_ids=<REDACTED> '<REDACTED>'] labels=['YES', 'NO'] one_fix_away=True tradeable=False blockers=['stale_book']
  - binary:event:211827 reason=stale_book score=0.75 market_ids=['1385754'] token_ids=<REDACTED> '<REDACTED>'] labels=['YES', 'NO'] one_fix_away=True tradeable=False blockers=['stale_book']

### 11c. Bregman Certifier / Candidate Health (read-only)

- bregman_groups_entered_certifier: 488
...
- bregman_real_market_zero_candidate_reason_counts: {'not_exhaustive': 244, 'stale_book': 244}
- bregman_depth_sufficient_groups: 98
- bregman_depth_sufficient_but_negative_edge_count: 97
- bregman_best_depth_sufficient_group_lower_bound: 0.938
- bregman_best_depth_sufficient_group_reject_reason: not_exhaustive
- best_real_group: event:event:36173 depth_sufficient=True min_leg_depth=$134.8534 (required $25.0) reject=not_exhaustive lower_bound=0.938 market_ids=['573655', '573656'] labels=['YES', 'YES']
  - sample: group=event:event:551781 reason=not_exhaustive depth_sufficient=False market_ids=['2419341', '2419350', '2419352', '2419355'] token_ids=<REDACTED> '<REDACTED>', '<REDACTED>', '<REDACTED>'] labels=['YES', 'YES', 'YES', 'YES']
...
- profit_lower_bound (min/mean/max): -14.491 / -0.182746 / 0.999
- groups by lower_bound sign (neg/zero/pos): 378 / 6 / 104
  - group: event:event:551781 exhaustive=False settlement_consistent=False profit_lower_bound=0.642 divergence_gap=0.103041 reason=not_exhaustive
  ...
  - group: binary:negrisk:<REDACTED> exhaustive=True settlement_consistent=True profit_lower_bound=-0.04 divergence_gap=0.0008 reason=stale_book
  ...
  - group: binary:event:261273 exhaustive=True settlement_consistent=True profit_lower_bound=-0.001 divergence_gap=5e-07 reason=stale_book
  - near_miss: binary:event:261273 stage=realism exhaustive=True settlement_consistent=True divergence_gap=5e-07 projected_lb=-0.001 reason=stale_book
  - near_miss: binary:event:107726 stage=realism exhaustive=True settlement_consistent=True divergence_gap=5e-07 projected_lb=-0.001 reason=stale_book
  - near_miss: binary:event:108634 stage=realism exhaustive=True settlement_consistent=True divergence_gap=5e-07 projected_lb=-0.001 reason=stale_book
...
- bregman_shadow_label_candidates: 74
- bregman_shadow_labels_written: 74
- bregman_shadow_label_write_rate: 1.0
- shadow_records_written: 26977
- shadow_labels_tail_nonempty: True
- shadow_label_write_rejection_reasons: {'already_written': 73}
- profit_discovery_queue_items: 493
- profit_discovery_queue_by_priority: {'3': 174, '5': 319}
- profit_learning_status: shadow_data_only
- profit_data_sufficiency: building
- bandit_router_enabled: True
- bandit_action_counts: {'bregman_depth_watchlist': 1, 'bregman_not_exhaustive_completer': 1, 'bregman_rebalancing_watchlist': 0, 'grok_news_linked_near_miss': 0, 'active_learning_shadow': 0}
- bandit_action_rewards: {'bregman_depth_watchlist': 3.0, 'bregman_not_exhaustive_completer': 3.0, 'bregman_rebalancing_watchlist': 0.0, 'grok_news_linked_near_miss': 0.0, 'active_learning_shadow': 0.0}
...
- targeted_markets_scanned_total: 1930
- targeted_scan_field_source: bregman_normalized_groups+raw_records
- targeted_scan_bregman_groups_seen: 493
- targeted_scan_binary_groups_seen: 246
- targeted_scan_yes_no_pairs_seen: 246
- targeted_scan_binary_group_matches: 242 raw_market_matches=1930
- targeted_scan_bregman_categories: {'high_liquidity_binary': 100, 'negative_risk_complete': 3, 'complete_event_family': 3}
- targeted_scan_raw_market_categories: {'negative_risk_complete': 72, 'short_resolution': 1122, 'btc_eth_chainlink': 144, 'fed_macro_reference': 27, 'high_volume_news_linked': 1, 'complete_event_family': 72}
- targeted_scan_normalized_reject_reasons: {'not_exhaustive': 244, 'stale_book': 249}
...
- bregman_clob_hydration_eligible_groups: 488 selected=250 coverage_rate=0.5123
...
- zero_trade_blocker_if_any: real_book_candidates_but_no_positive_after_cost_edge: real_book_candidates_seen=472; positive=0; best_after_cost_edge=0.0; best_reject={}
...
- paper_relaxed_after_cost_positive_seen: 0 real_clob_book_seen=472
- paper_relaxed_readiness_pnl_excluded: True
- paper_relaxed_pipeline_scanned: 978
- paper_relaxed_real_book_candidates_seen: 472 positive=0
- paper_relaxed_candidate_source_counts: {'mutually_exclusive': 9, 'binary_yes_no': 463}
- paper_relaxed_candidates_blocked_by_reason: {'stale_book': 472}
- bregman_false_incomplete_family_count: 0 near_miss_promoted=0
- bregman_incomplete_family_examples: [{'group_id': 'event:event:551781', 'n_legs_scanned': 4, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:548813', 'n_legs_scanned': 4, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:36173', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:591091', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:386788', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:255195', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:34051', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:386812', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}]
- bregman_missing_outcome_examples: [{'group_id': 'event:event:548786', 'present_outcomes_sample': ['Will Donald Trump publicly insult someone on June 16, 2026?', 'Will Donald Trump publicly insult someone on June 19, 2026?', 'Will Donald Trump publicly insult someone on June 2, 2026?', 'Will Donald Trump publicly insult someone on June 29, 2026?', 'Will Donald Trump publicly insult someone on June 3, 2026?', 'Will Donald Trump publicly insult someone on June 4, 2026?'], 'missing_outcome_count': 19}, {'group_id': 'event:event:577376', 'present_outcomes_sample': ['Will Iran close its airspace by June 30?', 'Will Iran close its airspace by July 31?', 'Will Iran close its airspace by December 31?', 'Will Iran close its airspace by June 10?', 'Will Iran close its airspace by June 12?', 'Will Iran close its airspace by June 11?'], 'missing_outcome_count': 1}, {'group_id': 'event:negrisk:<REDACTED>', 'present_outcomes_sample': ['Will Ronaldo Caiado win the 2026 Brazilian presidential election?', 'Will Michelle Bolsonaro win the 2026 Brazilian presidential election?', 'Will Renan Santos win the 2026 Brazilian presidential election?', 'Will Geraldo Alckmin win the 2026 Brazilian presidential election?', 'Will Flávio Bolsonaro win the 2026 Brazilian presidential election?', 'Will Fernando Haddad win the 2026 Brazilian presidential election?'], 'missing_outcome_count': 7}, {'group_id': 'event:negrisk:<REDACTED>', 'present_outcomes_sample': ["Will Valtteri Bottas be the 2026 F1 Drivers' Champion?", "Will Alexander Albon be the 2026 F1 Drivers' Champion?", "Will Franco Colapinto be the 2026 F1 Drivers' Champion?", "Will Isack Hadjar be the 2026 F1 Drivers' Champion?", "Will Lance Stroll be the 2026 F1 Drivers' Champion?", "Will Oliver Bearman be the 2026 F1 Drivers' Champion?"], 'missing_outcome_count': 2}, {'group_id': 'event:negrisk:<REDACTED>', 'present_outcomes_sample': ['Will Thomas Massie win the 2028 Republican presidential nomination?', 'Will J.D. Vance win the 2028 Republican presidential nomination?', 'Will Ron DeSantis win the 2028 Republican presidential nomination?', 'Will Ted Cruz win the 2028 Republican presidential nomination?', 'Will John Thune win the 2028 Republican presidential nomination?', 'Will Tucker Carlson win the 2028 Republican presidential nomination?'], 'missing_outcome_count': 85}, {'group_id': 'event:negrisk:<REDACTED>', 'present_outcomes_sample': ['Will Marco Rubio win the 2028 US Presidential Election?', 'Will Kamala Harris win the 2028 US Presidential Election?', 'Will Jalen Brunson win the 2028 US Presidential Election?', 'Will Zohran Mamdani win the 2028 US Presidential Election?', 'Will LeBron James win the 2028 US Presidential Election?', 'Will Andy Beshear win the 2028 US Presidential Election?'], 'missing_outcome_count': 83}, {'group_id': 'event:negrisk:<REDACTED>', 'present_outcomes_sample': ['Will Gavin Newsom win the 2028 Democratic presidential nomination?', 'Will James Talarico win the 2028 Democratic presidential nomination?', 'Will Graham Platner win the 2028 Democratic presidential nomination?', 'Will Ruben Gallego win the 2028 Democratic presidential nomination?', 'Will Beto O’Rourke win the 2028 Democratic presidential nomination?', 'Will Jon Stewart win the 2028 Democratic presidential nomination?'], 'missing_outcome_count': 75}, {'group_id': 'event:negrisk:<REDACTED>', 'present_outcomes_sample': ['Will Turkiye win the 2026 FIFA World Cup?', 'Will Czechia win the 2026 FIFA World Cup?', 'Will Bosnia-Herzegovina win the 2026 FIFA World Cup?', 'Will Iraq win the 2026 FIFA World Cup?', 'Will Congo DR win the 2026 FIFA World Cup?', 'Will Sweden win the 2026 FIFA World Cup?'], 'missing_outcome_count': 4}]
- accelerated_discovery_enabled: True
- markets_scanned_per_tick: 1930 candidates_evaluated_per_tick=488 shadow_labels_per_tick=150 no_trade_labels_per_tick=488
- near_miss_records_written: 493 bregman_diagnostics_records_written=978
- top_near_miss_edges_after_cost: [0.999, 0.999, 0.999, 0.999, 0.999, 0.999, 0.999, 0.998, 0.998, 0.998]
- top_bregman_rejection_reasons: [{'reason': 'stale_book', 'count': 491}, {'reason': 'not_exhaustive', 'count': 487}]
- report_buckets: {'realistic_executable_trades': 0, 'bregman_certified_bundles': 0, 'directional_exploit_trades': 0, 'shadow_exploration': 0, 'no_trade_labels': 488, 'near_miss_rejects': 493, 'paper_relaxed_exploration_trades': 0}
...
- market_quality_tier_counts: {'gold': 0, 'silver': 0, 'bronze': 724, 'watch': 866, 'reject_or_diagnostic': 340}
- market_quality_score_distribution: {'0.8+': 0, '0.6-0.8': 0, '0.4-0.6': 732, '0.2-0.4': 1084, '<0.2': 114}
- targeted_scan_budget_by_category: {'negative_risk_complete': 3, 'short_resolution': 895, 'btc_eth_chainlink': 128, 'fed_macro_reference': 27, 'high_volume_news_linked': 1, 'complete_event_family': 3, 'broad_exploration': 644}
- targeted_scan_markets_by_category: {'negative_risk_complete': 72, 'short_resolution': 1122, 'btc_eth_chainlink': 144, 'fed_macro_reference': 27, 'high_volume_news_linked': 1, 'complete_event_family': 72, 'broad_exploration': 707}
- high_liquidity_binary_markets_scanned: 100
- complete_yes_no_tight_spread_markets_scanned: 0
- negative_risk_complete_events_scanned: 75
- short_resolution_markets_scanned: 1122
- btc_eth_chainlink_markets_scanned: 144
- fed_macro_reference_markets_scanned: 27
- high_volume_news_linked_markets_scanned: 1
- complete_event_families_scanned: 75
- thin_depth_scan_waste_count (KNOWN-thin only): 1921
- stale_book_scan_waste_count (KNOWN-stale only): 1930
- targeted_scan_missing_data_counts (NOT waste): {'missing_book_timestamp': 0, 'missing_depth': 9, 'missing_volume': 1}
- scan_deprioritized_groups: 0 cooldown_active=0 reasons={}
- not_exhaustive_high_quality_groups: 0 (sibling=0 grok=0 shadow_only=0)
- targeted_scan_noop_reasons: {'complete_yes_no_tight_spread': '0/1930 markets matched complete_yes_no_tight_spread (binaries seen=246)', 'thin_depth_deprioritized': '0/1930 markets matched thin_depth_deprioritized (binaries seen=246)', 'stale_book_refresh': '0/1930 markets matched stale_book_refresh (binaries seen=246)'}
  - best: 2410560 tier=bronze score=0.539418 categories=['short_resolution', 'btc_eth_chainlink', 'high_volume_news_linked']
  - best: 2412401 tier=bronze score=0.51985 categories=['short_resolution']
  - best: 2518247 tier=bronze score=0.510918 categories=['short_resolution', 'btc_eth_chainlink']
...
- bregman_blocker: no_certified_bregman_opportunity: dominant_reject=not_exhaustive(731)
- relaxed_bregman_blocker: positive_candidates_found_but_unfilled: positive=1; dominant_reject_reason=stale_book; reject_reasons={'stale_book': 683, 'negative_after_cost_edge': 23, 'depth_insufficient_for_1usd': 1, 'bregman_leg_stale_book': 1}; best_reject={'group_id': 'binary:event:149812', 'group_type': 'binary_yes_no', 'after_cost_edge': -0.003502, 'reject_reason': 'negative_after_cost_edge', 'depth_for_1usd': 1.0278, 'n_legs': 2}
...
- paper_trade_acceleration_blocker_if_any: no_paper_trade_opened_in_any_lane: bregman=no_certified_bregman_opportunity: dominant_reject=not_exhaustive(731); relaxed_bregman=positive_candidates_found_but_unfilled: positive=1; dominant_reject_reason=stale_book; reject_reasons={'stale_book': 683, 'negative_after_cost_edge': 23, 'depth_insufficient_for_1usd': 1, 'bregman_leg_stale_book': 1}; best_reject={'group_id': 'binary:event:149812', 'group_type': 'binary_yes_no', 'after_cost_edge': -0.003502, 'reject_reason': 'negative_after_cost_edge', 'depth_for_1usd': 1.0278, 'n_legs': 2}; tiny_directional=no_active_learning_tiny_selection: exploration_enabled=True; active_learning_enabled=True; btc_pulse=btc_pulse_disabled
...
- exploration_pnl: 0
- avg_active_learning_score_selected: 0.0
- avg_execution_quality_selected: 0.0
- top_learning_buckets: []
- category_coverage: {}
...
- metrics: present (not copied) (91192147 bytes)
- reports: copied (13069 bytes)
- training: present (not copied) (9567142789 bytes)
- micro_live_artifacts: copied (7242372 bytes)
