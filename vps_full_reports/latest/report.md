...
_Generated: 2026-06-18T23:53:42.500790+00:00 · PAPER ONLY · inspection/reporting only_
...
| fast_btc_price | 62806.285 |
| feed_disagreement_bps | None |
| market_stale_time_s | 2766.739 |
...
| groups_scanned_positive | OK | constraint_groups_scanned=472.0 |
...
- Paper training running: yes · runtime: 22.87 min
...
- preflight_ok: yes · scanned=2000 kept=1772
...
- chainlink_valid: yes
- chainlink_stale: no
- chainlink_age_seconds: 2766.739
...
- btc_fast_price_disagreement_bps: 4.943
...
- grok_calls_total: 8
- grok_calls_with_news: 8
- grok_proof_calls_total: 0
- grok_scheduler_calls_total: 8
- grok_total_calls_reconciled: True
- grok_scheduled_calls: 8
- grok_scheduler_eligible_targets: 513
- grok_scheduler_targets_selected: 8
- grok_scheduler_targets_skipped: 0
- grok_scheduler_skip_reasons: {}
- grok_advisory_only_count: 8
- grok_evidence_records_written: 8
- grok_advisory_max_calls_per_hour: 60
- grok_advisory_calls_per_hour: 8
- grok_market_groups_analyzed: 7
- grok_bregman_near_misses_analyzed: 7
- grok_bregman_incomplete_groups_analyzed: 7
- grok_bregman_malformed_groups_analyzed: 4
- grok_news_linked_markets_analyzed: 8
- grok_learning_features_written: 8
...
- max_bregman_distance: 0.135
- mean_cost_per_set: 1.015429
- expected_min_profit: 0.0
- near_miss_count: 10
- stage_rejections: {'adapter_failed': 1451, 'certifier_no_positive_profit': 781, 'realism_fees_spread_depth': 0, 'other': 0}
...
- bregman_near_misses_total: 500
- near_miss_one_fix_away_count: 123
- near_miss_depth_only_count: 105
- near_miss_not_exhaustive_count: 251
- near_miss_stale_refresh_failed_count: 0
- near_miss_by_rejection_reason: {'depth_too_thin': 73, 'no_executable_price': 4, 'no_positive_edge': 154, 'not_exhaustive': 251, 'spread_too_wide': 2, 'stale_book': 16}
- near_miss_learning_priority_counts (high/med/low): {'high': 88, 'medium': 273, 'low': 139}
- near_miss_shadow_label_candidate_count: 88
- near_miss_learning_label_counts: {'needs_multiple_fixes': 261, 'no_positive_after_cost_edge': 116, 'would_certify_if_book_fresh': 2, 'would_certify_if_complete_set': 16, 'would_certify_if_depth_sufficient': 105}
  ...
  - learn: binary:event:73042 priority=high(1.0) label=would_certify_if_depth_sufficient shadow_candidate=True would_trade_if=worst-leg depth $6.2596 reaches required $25.0 (thin legs=1)
...
- malformed_group_count: 313266
- parsed_price_success_rate: 1.0
- bregman_depth_sufficient_groups: 98
- bregman_depth_insufficient_groups: 374
- bregman_high_liquidity_groups_scanned: 54
...
- bregman_groups_entered_certifier: 472
...
- bregman_real_market_zero_candidate_reason_counts: {'depth_too_thin': 86, 'no_executable_price': 4, 'no_positive_edge': 114, 'not_exhaustive': 241, 'spread_too_wide': 3, 'stale_book': 24}
- bregman_depth_sufficient_groups: 98
...
- best_real_group: event:event:36173 depth_sufficient=True min_leg_depth=$133.8742 (required $25.0) reject=not_exhaustive lower_bound=0.938 market_ids=['573655', '573656'] labels=['YES', 'YES']
...
- malformed_group_count (reconciled): 313266
- bregman_malformed_group_reported_count (trainer certifier): 0
- bregman_malformed_group_runtime_count (ABCAS scanner): 464
- bregman_malformed_group_tail_count (diagnostics tail): 313266
- bregman_malformed_group_legacy_or_tail_only_count: 312802
- source: abcas_scanner_path_real_rejects

### 11d-stage. Trainer Certifier Per-Stage Census (read-only)

- bregman_rejection_stage_counts: {'edge': 114, 'realism': 117, 'validate_simplex': 241}
- bregman_max_divergence_gap (D(mu*||theta)): 11.15224644
- bregman_best_projected_lower_bound: 0.999
- bregman_positive_projected_but_rejected_count: 106
- bregman_positive_projected_rejected_by_stage: {'realism': 10, 'validate_simplex': 96}
- WHY certified=0: dominant stage=validate_simplex: groups are structurally INCOMPLETE (exhaustive=False / not a provable complete set) — buying a partial set is not a guaranteed hedge, so it is correctly NOT certified (completeness is never fabricated); NOTE: 106 group(s) had POSITIVE raw projected profit (best=0.999) but were still rejected (realism=10, validate_simplex=96) — the raw mispricing is real, but the set is not a certifiable complete hedge
- profit_lower_bound (min/mean/max): -15.164 / -0.179127 / 0.999
- groups by lower_bound sign (neg/zero/pos): 361 / 5 / 106
  - group: event:event:551781 exhaustive=False settlement_consistent=False profit_lower_bound=0.609 divergence_gap=0.09272025 reason=not_exhaustive
  - group: event:event:548813 exhaustive=False settlement_consistent=False profit_lower_bound=-1.04 divergence_gap=0.2752 reason=not_exhaustive
  - group: binary:negrisk:<REDACTED> exhaustive=True settlement_consistent=True profit_lower_bound=-0.08 divergence_gap=0.0032 reason=depth_too_thin
  - group: binary:event:108639 exhaustive=True settlement_consistent=True profit_lower_bound=-0.001 divergence_gap=5e-07 reason=depth_too_thin
...
- bregman_shadow_label_candidates: 88
- bregman_shadow_labels_written: 110
- bregman_shadow_label_write_rate: 1.25
- shadow_records_written: 24913
- shadow_labels_tail_nonempty: True
- shadow_label_write_rejection_reasons: {'already_written': 590}
- profit_discovery_queue_items: 500
- profit_discovery_queue_by_priority: {'1': 7, '2': 105, '3': 96, '5': 292}
...
- targeted_markets_scanned_total: 1836
- targeted_scan_field_source: bregman_normalized_groups+raw_records
- targeted_scan_bregman_groups_seen: 500
- targeted_scan_binary_groups_seen: 246
- targeted_scan_yes_no_pairs_seen: 246
- targeted_scan_binary_group_matches: 237 raw_market_matches=1827
- targeted_scan_bregman_categories: {'complete_yes_no_tight_spread': 221, 'high_liquidity_binary': 118, 'negative_risk_complete': 3, 'complete_event_family': 3}
- targeted_scan_raw_market_categories: {'complete_yes_no_tight_spread': 4, 'negative_risk_complete': 64, 'short_resolution': 1060, 'btc_eth_chainlink': 152, 'fed_macro_reference': 29, 'high_volume_news_linked': 1, 'complete_event_family': 64}
- targeted_scan_normalized_reject_reasons: {'not_exhaustive': 251, 'depth_too_thin': 73, 'no_positive_edge': 154, 'stale_book': 16, 'no_executable_price': 4, 'spread_too_wide': 2}
...
- bregman_clob_hydration_eligible_groups: 472 selected=250 coverage_rate=0.5297
...
- market_quality_tier_counts: {'gold': 0, 'silver': 1, 'bronze': 753, 'watch': 805, 'reject_or_diagnostic': 277}
- market_quality_score_distribution: {'0.8+': 0, '0.6-0.8': 0, '0.4-0.6': 761, '0.2-0.4': 983, '<0.2': 92}
- targeted_scan_budget_by_category: {'complete_yes_no_tight_spread': 3, 'negative_risk_complete': 1, 'short_resolution': 887, 'btc_eth_chainlink': 136, 'fed_macro_reference': 29, 'high_volume_news_linked': 1, 'complete_event_family': 1, 'broad_exploration': 620}
- targeted_scan_markets_by_category: {'complete_yes_no_tight_spread': 4, 'negative_risk_complete': 64, 'short_resolution': 1060, 'btc_eth_chainlink': 152, 'fed_macro_reference': 29, 'high_volume_news_linked': 1, 'complete_event_family': 64, 'broad_exploration': 674}
- high_liquidity_binary_markets_scanned: 118
- complete_yes_no_tight_spread_markets_scanned: 225
- negative_risk_complete_events_scanned: 67
- short_resolution_markets_scanned: 1060
...
- thin_depth_scan_waste_count (KNOWN-thin only): 1828
- stale_book_scan_waste_count (KNOWN-stale only): 1761
- targeted_scan_missing_data_counts (NOT waste): {'missing_book_timestamp': 0, 'missing_depth': 9, 'missing_volume': 0}
- scan_deprioritized_groups: 6 cooldown_active=1869 reasons={'invalid_simplex': 2, 'stale_book': 6, 'thin_depth': 6}
- not_exhaustive_high_quality_groups: 7 (sibling=7 grok=7 shadow_only=7)
- targeted_scan_noop_reasons: {'thin_depth_deprioritized': '0/1836 markets matched thin_depth_deprioritized (binaries seen=246)', 'stale_book_refresh': '0/1836 markets matched stale_book_refresh (binaries seen=246)'}
  - best: 2532420 tier=silver score=0.596112 categories=['short_resolution', 'btc_eth_chainlink', 'high_volume_news_linked']
  - best: 2410569 tier=bronze score=0.575411 categories=['short_resolution', 'btc_eth_chainlink']
  - best: 2549212 tier=bronze score=0.565905 categories=['short_resolution', 'btc_eth_chainlink']
...
- bregman_blocker: no_certified_bregman_opportunity: dominant_reject=not_exhaustive(1946)
...
- Legacy random exploration blocked: 50
...
- exploration_shadow_only: 198
- exploration_rejected_by_realism: 21
- exploration_rejected_by_budget: 0
- exploration_rejected_by_collision: 0
- exploration_rejected_by_diversity: 0
- exploration_budget_used_usd: 3.5
- exploration_expected_loss_usd: 0.0245
- exploration_pnl: 0
- avg_active_learning_score_selected: 0.423543
- avg_execution_quality_selected: 0.1924
...
- top_open_clusters: [{'cluster': 'event:414231', 'count': 1, 'notional': 1.7501}, {'cluster': 'event:57705', 'count': 1, 'notional': 1.75}]
...
- metrics: present (not copied) (88347764 bytes)
- reports: copied (13773 bytes)
- training: present (not copied) (9453402770 bytes)
- micro_live_artifacts: copied (6080016 bytes)
...
- [WARN] NOT RUN-READY: stale_or_mixed_training_tail_samples: decision_records.jsonl: last_run_id=pmtrain-1781825288 != events run_id=pmtrain-1781826812; no_trade_labels.jsonl: last_run_id=pmtrain-1781825288 != events run_id=pmtrain-1781826812; pending_labels.jsonl: last_run_id=pmtrain-1781825288 != events run_id=pmtrain-1781826812
