...
## Summary
- **Truly active (control trades):** Trainer Bregman certifier, Bregman paper execution, Bregman INPUT UNIVERSE (catalog vs shortlist), Random/hash exploration, Stale-book rejection, Spread/depth gates, Ambiguity gate, Chainlink conditioning, News/research/model overlay, Position/open-slot governor, Stop-loss/take-profit/settlement handling
...
- Status counts: {'active': 11, 'telemetry': 2, 'annotated': 2, 'imported': 2, 'dead': 3}
