...
from engine.training.btc_signal import (BtcSignalEngine, fair_value_above, parse_btc_market,
                                         realized_vol_per_sec, rsi)
...
def test_engine_directional_signal_bounded():
    ...
    assert sig is not None and sig.kind == "directional"
