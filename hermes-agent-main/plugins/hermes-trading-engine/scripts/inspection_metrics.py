...
def extract_features(status: dict | None, api: dict | None = None,
    ...
    feats: dict[str, Any] = {
        ...
        "normalized_markets": _get(status, "bregman", "normalized_markets"),
        "constraint_groups_discovered": _get(status, "bregman", "constraint_groups_discovered"),
        "aggressive_paper_training_enabled": _first(
            (env or {}).get("AGGRESSIVE_PAPER_TRAINING"),
            _get(status, "bregman", "abcas_mode") == "aggressive_paper" or None),
        "bregman_groups_skipped": _get(status, "bregman", "groups_skipped"),
        "bregman_candidates_found": _first(_get(status, "bregman", "candidate_arbitrages"),
                                           mon.get("bregman_opportunities"),
